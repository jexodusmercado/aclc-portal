                                ...
                                { !loading && quizzes.map((quiz) => (
                                    ...
                                    >
                                        ...
                                        <td className="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <Link to={`${quiz.id}/answer`} className={classNames(quiz.is_answered ? 'pointer-events-none' : '', `text-blue-600 hover:text-blue-900`)}>
                                                {
                                                    quiz.is_answered ?
                                                    'Taken'
                                                    :
                                                    <>
                                                        Take Quiz<span className="sr-only">, {quiz?.classroom?.title}</span>
                                                    </>
