...
const navigation = [
  ...
  { name: 'Subjects', href: '/dashboard/admin/subjects', icon: FolderIcon },
  { name: 'Courses', href: '/dashboard/admin/courses', icon: CalendarIcon },
  { name: 'Classrooms', href: '/dashboard/admin/classrooms', icon: InboxIcon },
